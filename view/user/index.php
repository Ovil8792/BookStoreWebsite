...
<div class="col-12 mb-3 mb-sm-0">
    <form action="index.php?act=suaTTUser" method="POST" class="card h-100" enctype="multipart/form-data">
        <div class="card-body">
            ...
            <img class="rounded-circle" width="200px" src="../admin/uploads/Users/<?=$dataUser['avatar']?>" alt="Avatar người dùng" style="max-height:200px;margin-right:300px" > <br>
